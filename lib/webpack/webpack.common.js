 ...
 * @Last Modified time: 2019-02-19 20:58:12
 * webpack公共配置
 */
...
module.exports = (env, argv) => {
  ...
  return {
    ...
    resolveLoader: {
      modules: ['node_modules', cwd(), cwd('node_modules'), ownDir('node_modules'), ownDir('lib/loaders')]
    },
    module: {
      rules: [
        {
        ...
        },
        {
          ...
          use: 'happypack/loader?id=h-eslint'
          // loader: "eslint-loader",
        },
        {
          test: /\.jsx?$/,
          ...
          use: [
            {
              // loader: 'babel-loader',
              loader: 'happypack/loader?id=h-babel'
            },
            {
              loader: 'babel-loader'
            }
